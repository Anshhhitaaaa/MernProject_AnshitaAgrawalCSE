...
export const Header = ({ onLogout, onCoursesClick, onHomeClick, onDashboardClick, onCalendarClick, onPortfolioClick, onTestClick, onNotificationsClick, onProfileClick }) => {
